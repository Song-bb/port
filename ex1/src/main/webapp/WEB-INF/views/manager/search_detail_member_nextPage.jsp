	...
	<c:import url="header_management.jsp"></c:import>
        ...
        <div class="member_manager_select_page">
            <table class="member_manager_select_page_table">
                <tr>
               		<td class="member_manager_select_page_td"><a href="/search_detail_member_nextPage?date_min=${date_min}&date_max=${date_max}&buying_min=${buying_min}&buying_max=${buying_max}&grade=${grade}&point_min=${point_min}&point_max=${point_max}&page=1"><<</a></td>
