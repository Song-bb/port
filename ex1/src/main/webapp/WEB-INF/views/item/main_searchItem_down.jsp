...
<!-- 메인 상품검색 -->
	...
	<div id="importedpage_wrap">
	    ...
	    <div id="importedpage_top_nav"><a href="/main_searchItem_new?search=${ search_text }">최신순 </a> | <a href="/main_searchItem_down?search=${ search_text }">낮은 가격 순 </a> | <a href="/main_searchItem_high?search=${ search_text }">높은 가격 순 </a></div>
