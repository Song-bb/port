            ...
            <div class="servicePage_title">마이과장</div>
	           <div class="servicePage_side_table_div">
	               <table class="servicePage_side_table">
	                   ...
	                   <tr>
	                       <td class="selected_page_td"><a href="/check_password"><div>개인정보수정<span>></span></div></a></td>
	                   </tr>
	               </table>
	           </div>
		    ...
		    <div id="delete_user_wrap">
		        ...
		        <div id="delete_user_foot">
		            ...
		            <div id="delete_user_foot_body">
		            	<form action="/leave_gwailJangsu" method="post">
			                <table id="delete_user_foot_body_table">
			                    <tr class="delete_user_foot_body_table_tr_1">
			                        ...
			                        <td class="delete_user_foot_body_table_td_2"><input type="text" name="user_pw" required="required"></td>
			                    </tr>
			                    <tr class="delete_user_foot_body_table_tr">
			                        ...
			                        <td class="delete_user_foot_body_table_td_2">
			                            <input type="radio" name="reason" value="고객서비스(상담,포장 등) 불만">고객서비스(상담,포장 등) 불만
			                            <input type="radio" name="reason" value="배송불만">배송불만
			                            <input type="radio" name="reason" value="교환/환불/반품 불만">교환/환불/반품 불만<br>
			                            <input type="radio" name="reason" value="빈도가">방문 빈도가 낮음
			                            <input type="radio" name="reason" value="상품가격 불만">상품가격 불만
			                            <input type="radio" name="reason" value="개인 정보유출 우려">개인 정보유출 우려<br>
			                            <input type="radio" name="reason" value="쇼핑몰의 신뢰도 불만">쇼핑몰의 신뢰도 불만
			                            <input type="radio" name="reason" value="쇼핑 기능 불만">쇼핑 기능 불만
			                        </td>
			                    </tr>
			                    <tr class="delete_user_foot_body_table_tr">
